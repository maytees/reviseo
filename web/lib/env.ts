...
export const env = createEnv({
	...
	client: {
		...
		NEXT_PUBLIC_S3_BUCKET_NAME_IMAGE_EDITS: z.string().min(1),
	...
	experimental__runtimeEnv: {
		...
		NEXT_PUBLIC_S3_BUCKET_NAME_IMAGE_EDITS:
			process.env.NEXT_PUBLIC_S3_BUCKET_NAME_IMAGE_EDITS,
