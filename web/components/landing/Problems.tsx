...
import { MacAppMock, MacAppMockContent, MacAppMockHeader, MacAppMockTitle } from "../ui/mac-app-mock";
    ...
    return (
        <section className="mt-48 w-full flex flex-col items-center justify-center px-4 sm:px-6 md:px-8">
            <div className="flex flex-col items-center justify-center gap-4 max-w-3xl">
                ...
                >
                    You&apos;re spending more time on client communication than actual development work.
                </motion.p>
            </div>
