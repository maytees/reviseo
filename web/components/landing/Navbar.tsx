            ...
            <nav className="hidden justify-between lg:flex w-full items-center">
                ...
                <Link href={logo.url} className="flex items-center gap-1">
                    <Image
                        ...
                        alt={logo.alt}
                    />
                    <h1 className="text-4xl font-bold font-caudex">
                        {logo.title}
                    </h1>
                </Link>
                        ...
                        <SheetContent className="overflow-y-auto">
                            ...
                            <div className="flex flex-col gap-6 p-4">
                                ...
                                <div className="flex flex-col gap-3">
                                    <Button asChild>
                                        <Link href={auth.getStarted.url}>{auth.getStarted.title}</Link>
                                    </Button>
                                </div>
                            </div>
                        </SheetContent>
...
const renderMobileMenuItem = (item: MenuItem) => {
    return (
        <Link key={item.title} href={item.url} className="text-lg hover:text-accent-foreground font-semibold font-alegreya">
            {item.title}
        </Link>
    );
};
