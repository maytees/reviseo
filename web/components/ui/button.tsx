  ...
  "cursor-pointer group whitespace-nowrap focus-visible:outline-hidden inline-flex items-center justify-center has-data-[arrow=true]:justify-between whitespace-nowrap text-sm font-medium ring-offset-background transition-[color,box-shadow] disabled:pointer-events-none disabled:opacity-60 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        success:
          "bg-green-600 text-white hover:bg-green-600/90 data-[state=open]:bg-green-600/90",
        destructive:
        ...
        inset:
          "bg-background text-accent-foreground border border-input hover:bg-accent data-[state=open]:bg-accent shadow-[inset_0_3px_6px_0_rgba(0,0,0,0.25)]",
        dashed:
    ...
    compoundVariants: [
      ...
      },
      {
        ...
        appearance: "ghost",
        className:
          "bg-transparent text-green-600 hover:bg-green-600/5 data-[state=open]:bg-green-600/5",
      },
      {
        variant: "destructive",
        appearance: "ghost",
